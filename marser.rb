...
class Marser
  ...
  def initialize
    @marc_raw = File.readlines('marc21.txt', 'r:utf-8')[0].lines.map(&:chomp).select { |line|  line if !line.match(/^\s*$/) && !line.match(/^--.+/) }
    @marc = step marc_raw
  end
...
# pp marser.get_tags_with_indicators
# pp marser.get_tags_without_indicators

# pp marser.get_defined_indicators
# pp marser.get_undefined_indicators

# pp marser.get_indicators( '856' )
# pp marser.get_indicators( '001' )  ## => {}

# pp marser.get_subfields( '856' )
# pp marser.get_subfields( '001' )   ## => {}

# pp marser.get_subfield( '856$b' )
# pp marser.get_subfield( '856$b' )
# pp marser.get_subfield( '856$7' )  ## => ''

# pp marser.subfield_repeatable?( '856$b' )   ## => true
# pp marser.subfield_repeatable?( '856$h' )   ## => false
# pp marser.subfield_repeatable?( '856$7' )   ## => nil

pp marser.get_indicator( '856i1=4' )
